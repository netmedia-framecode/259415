...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_wisata_kuliner_khas_bajawa']['name_page'])) {
                          if (!empty($_SESSION['project_wisata_kuliner_khas_bajawa']['name_page'])) {
                            echo " - " . $_SESSION['project_wisata_kuliner_khas_bajawa']['name_page'];
                          }
                        } ?>
</title>
